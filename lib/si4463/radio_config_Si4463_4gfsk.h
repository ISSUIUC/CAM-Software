...
// MOD_type: 5    Rsymb(sps): 100000    Fdev(Hz): 80000    RXBW(Hz): 400000    Manchester: 0    AFC_en: 1    Rsymb_error: 0.1    Chip-Version: 2    
// RF Freq.(MHz): 433    API_TC: 29    fhst: 500000    inputBW: 1    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// API_ARR_Det_en: 0    Fdev_error: 0    API_ETSI: 0    
// 
// # RX IF frequency is  -468750 Hz
// # WB filter 2 (BW = 412.25 kHz);  NB-filter 2 (BW = 412.25 kHz)
// 
// Modulation index: 1.6
*/
...
*/
// NOTE: Changed BOOT_OPTIONS from 0x81 (patch mode) to 0x01 (normal mode)
// Patch mode requires loading firmware patches which our init doesn't do
#define RF_POWER_UP 0x02, 0x01, 0x00, 0x01, 0xC9, 0xC3, 0x80

/*
// Command:                  RF_GPIO_PIN_CFG
// Description:              Configures the GPIO pins.
//   GPIO0: 0x00 = DONOTHING
//   GPIO1: 0x08 = CTS (Clear-to-Send output for hardware CTS polling)
//   GPIO2: 0x00 = DONOTHING
//   GPIO3: 0x00 = DONOTHING
//   NIRQ:  0x00 = DONOTHING (use default behavior)
//   SDO:   0x00 = DONOTHING
*/
...
*/
#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x20, 0x10, 0x00, 0x0F, 0xB1, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_PKT_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x00, 0x04, 0x00, 0x30, 0xFF, 0xFF, 0x20, 0x22, 0x00, 0x00, 0x00, 0x00, 0x10
...
*/
#define RF_PKT_RX_THRESHOLD_12 0x11, 0x12, 0x0C, 0x0C, 0x10, 0x00, 0x07, 0x10, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x05, 0x00, 0x07, 0x1E, 0x84, 0x80, 0x09, 0xC9, 0xC3, 0x80, 0x00, 0x41
...
*/
#define RF_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0x89
...
*/
#define RF_MODEM_TX_RAMP_DELAY_12 0x11, 0x20, 0x0C, 0x18, 0x05, 0x00, 0x08, 0x03, 0x80, 0x00, 0x00, 0x20, 0x00, 0xE8, 0x00, 0x96
...
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x03, 0x69, 0xD0, 0x00, 0xB6, 0x00, 0x12, 0x00, 0x00, 0x23, 0x86, 0xD4
...
*/
#define RF_MODEM_AFC_LIMITER_1_3 0x11, 0x20, 0x03, 0x30, 0x01, 0xA6, 0xE0
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12 0x11, 0x20, 0x0C, 0x38, 0x11, 0x21, 0x21, 0x00, 0x1A, 0x66, 0x66, 0x00, 0x29, 0x0C, 0xA4, 0x23
...
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x03, 0x02, 0x99, 0x02, 0x00, 0xFF, 0x06, 0x00, 0x18, 0x40
...
*/
#define RF_MODEM_DSA_CTRL1_5 0x11, 0x20, 0x05, 0x5B, 0x40, 0x24, 0x13, 0x78, 0x20
